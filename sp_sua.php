            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-7" style="padding-bottom:120px">
                        <form action="" method="POST" enctype="multipart/form-data" name="frmSuaSP" id="frmSuaSP">
                            ...
                            <div class="form-group">
                                <label>Sản phẩm giá cũ</label>
                                <input type="number" class="form-control" name="txtGiaCu" id="txtGiaCu" placeholder="Vui lòng nhập giá cho sản phẩm" />
                            </div>
                             <div class="form-group">
